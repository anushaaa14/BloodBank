...
public class Add {
    ...
    public static void create() {
        ...
        JLabel main = new JLabel("Add Blood");
        ...
        add.addActionListener(e -> {
            ...
            Integer dq = Integer.parseInt(quantity.getText());

            if(dbg.equals("") || dq.equals("")){
                ...
                try {
                    ...
                    stat.executeUpdate("update blood set quantity = quantity + " + dq + " where bloodgrp = '" + dbg + "'");
